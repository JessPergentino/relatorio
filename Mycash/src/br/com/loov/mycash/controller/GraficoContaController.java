...
@WebServlet("/GraficoContaController")
public class GraficoContaController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		conta = contaDao.getByID(Integer.parseInt(id));
	...
	private PieDataset carregarDados() {
		...
		List<Debito> debitos = debitoDao.listarConta(conta.getId());
